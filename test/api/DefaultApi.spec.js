...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.simpleInvestment);
  }
}(this, function(expect, simpleInvestment) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new simpleInvestment.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('accountOverview', function() {
      it('should call accountOverview successfully', function(done) {
        //uncomment below and update the code to test accountOverview
        //instance.accountOverview(pet, function(error) {
